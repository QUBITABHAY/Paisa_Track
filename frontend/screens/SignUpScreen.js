        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          ...
          >
            ...
            <View className="items-center mb-6">
              <View className="w-24 h-24 rounded-3xl mb-4 justify-center items-center">
                <Ionicons name="person-add-outline" size={48} color="blue" />
              </View>
            ...
            <View className="w-full max-w-sm mx-auto">
              <View className="mb-4">
                ...
                <View className={`flex-row items-center bg-white rounded-xl px-4 py-4 border-2 ${errors.username ? 'border-red-400 bg-red-50' : 'border-gray-200 focus:border-blue-400'} shadow-sm`}>
              ...
              <View className="mb-4">
                ...
                <View className={`flex-row items-center bg-white rounded-xl px-4 py-4 border-2 ${errors.email ? 'border-red-400 bg-red-50' : 'border-gray-200 focus:border-blue-400'} shadow-sm`}>
                ...
                {errors.email && (
                  <Text className="text-red-500 text-sm mt-2 ml-1 font-medium">{errors.email}</Text>
                )}
              </View>

              <View className="mb-4">
                <Text className="text-gray-700 font-semibold mb-2 text-base">Password</Text>
                <View className={`flex-row items-center bg-white rounded-xl px-4 py-4 border-2 ${errors.password ? 'border-red-400 bg-red-50' : 'border-gray-200 focus:border-blue-400'} shadow-sm`}>
              ...
              <View className="mb-6">
                ...
                <View className={`flex-row items-center bg-white rounded-xl px-4 py-4 border-2 ${errors.confirmPassword ? 'border-red-400 bg-red-50' : 'border-gray-200 focus:border-blue-400'} shadow-sm`}>
                ...
                {errors.confirmPassword && (
                  <Text className="text-red-500 text-sm mt-2 ml-1 font-medium">{errors.confirmPassword}</Text>
                )}
              </View>
